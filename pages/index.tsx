...
export default function Home() {
  return (
    <div className="border-2 border-yellow-600 flex flex-col ml-1/6 h-screen">
      <div className="border-2 border-red-500 items-right text-right justify-center w-full h-1/10">
        Icon Bar
      </div>
      ...
      <div className="border-2 border-green-500 flex w-full h-4/6">
        <div className="border-2 border-blue-500 flex flex-col w-1/2 h-full">
          left
          <div className="border-2 border-blue-200 p-2 m-5 h-2/5">
            social feed
          </div>
          <div className="border-2 border-blue-200 p-2 m-5 h-3/5">
            current projects
          </div>
        </div>
        <div className="border-2 border-red-500 flex flex-col w-1/2 h-full">
          ...
          <div className="border-2 border-blue-200 p-2 m-5 h-1/5">
            Challenges
          </div>
        </div>
      </div>
